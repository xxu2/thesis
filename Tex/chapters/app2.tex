...
use to quantify the observation error in the inverse modeling optimization. 
 ...
 \begin{figure}[t]
  ...
  \caption[The 0.65 $\mu$m AOD retrieved by \citep{Wang10} compared with
the MODIS operational collection 5 AOD products.]
{The 0.65 $\mu$m AOD retrieved by \citep{Wang10} compared with the 
...
\section{Inversion Results} \label{sec:invresult}
 ...
 \begin{figure}[t]
  ...
  \caption[Comparison of the prior and posterior AODs with MODIS
operational products.]
 {Comparison of the prior (a) and posterior (b) GEOS-Chem (GC) simulation
...
\end{table}
 ...
 \begin{figure}[p]
  ...
  \caption[The prior (bottom-up based), optimized (top-down constrained)
aerosol emissions over China for the period of April 2008.]
  {The prior (or bottom-up based, left column), optimized (or
...
April 2008.]{Comparison of the prior and posterior GEOS-Chem simulation of
0.55 $\mu$m AOD with the level 3 MISR 0.55 $\mu$m AOD for the period
...
GEOS-Chem \ce{SO2} simulation with OMI column \ce{SO2} retrievals for
the period of April 2008.]
{Same as figure \ref{fig:misr1} but for comparison of the
GEOS-Chem \ce{SO2} simulation with OMI column \ce{SO2} retrievals for
the period of April 2008. The OMI planetary boundary layer (PBL) column
\ce{SO2} from the Level 3 daily products with 0.25$^{\circ}$ by
0.25$^{\circ}$ resolutions are aggregated into GEOS-Chem grid cells.}
 ...
 \begin{figure}[t]
  ...
  \caption[Same as figure \ref{fig:misr1} but for comparison of the
GEOS-Chem \ce{NO2} simulation with OMI column \ce{NO2} retrievals for
the period of April 2008.]{Same as figure \ref{fig:misr1} but for
comparison of the GEOS-Chem \ce{NO2} simulation with OMI column \ce{NO2}
retrievals for the period of April 2008.  The OMI tropospheric column
\ce{NO2} from Level 2 daily products with 0.25$^{\circ}$ by
0.25$^{\circ}$ resolutions are aggregated into GEOS-Chem grid cells.}
  \label{fig:omno2}
 \end{figure}
 ...
 \begin{figure}[ht]
  ...
  \caption[Comparison of the GEOS-Chem surface mass concentration of
sulfate-nitrate-ammonium aerosols with ground-based observations
over Qingdao, China.]{Comparison of the GEOS-Chem surface mass concentration of
sulfate-nitrate-ammonium (SNA) aerosols with ground-based observations
over Qingdao (120.34$^{\circ}$ E, 36.06$^{\circ}$ N), China.
Discontinuity in time series is due to missing or quality filtered
observations.}
  \label{fig:sna}
 \end{figure}
 ...
 \begin{figure}[t]
  ...
  \caption[Time serial plot of the GEOS-Chem simulated surface
PM\textsubscript{10} concentrations by prior  and posterior
aerosol emissions compared with the \textit{in situ} measured
PM\textsubscript{10}.]{Time serial plot of the GEOS-Chem simulated
surface PM\textsubscript{10} concentrations by prior (red) and posterior
(red) aerosol emissions compared with the \textit{in situ} measured
PM\textsubscript{10} (black) over Zhangye (a) and SACOL (b) stations for
15 – 30 April 2008; also shown are the average values over same the
period. Discontinuity in time series is due to missing or quality
...
\ce{SO2}, (4) OMI column \ce{NO2}, (5) surface SNA concentrations at
...
from MODIS and MISR Level 3 daily products.]
  {Change of April monthly 0.55 $\mu$m AOD from 2006 to 2008
